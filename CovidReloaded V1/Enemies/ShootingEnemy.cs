...
{
    public class ShootingEnemy : GameObject
    {
        //speciale vijand,als speler deze raakt 
        //wordt score opgeteld met 200 ipv 100
        public int Health { get; set; }
        public ShootingEnemy(Texture2D texture, Vector2 position, Vector2 size, Vector2 movement, int health)
